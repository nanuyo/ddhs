...
#define OUTPUT_ROTATE_FILE1 "rotated_image1.jpg"
#define OUTPUT_ROTATE_FILE2 "rotated_image2.jpg"
#define OUTPUT_ROTATE_FILE3 "rotated_image3.jpg"
...
int main()
{
    ...
    system("python /usr/bin/ims/rotate.py");

    client_jpg_sender(OUTPUT_ROTATE_FILE1);
    client_jpg_sender(OUTPUT_ROTATE_FILE2);
    client_jpg_sender(OUTPUT_ROTATE_FILE3);
